...
import 'package:kaku/features/dashboard/widgets/empty_transactions.dart';
import 'package:kaku/features/dashboard/widgets/transaction_item.dart';
...
class TransactionsList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return txAsync.when(
      ...
      data: (transactions) {
        if (transactions.isEmpty) return const EmptyTransactions();
